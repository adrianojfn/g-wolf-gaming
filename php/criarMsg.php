...
$autor_img = $_SESSION['usuarioImgPerfil'];
...
$sql_msg = "INSERT INTO mensagens_topico (conteudo_msg, autor_msg, img_autor_msg, topico_msg, data_msg) VALUES ('$conteudo_msg', '$autor_msg', '$autor_img', '$topico', NOW())";
