...
$imgPerfil = filter_input(INPUT_POST, 'imgPerfil', FILTER_SANITIZE_STRING);

// Envia os dados recebidos do formulário através das variáveis para a tabela do banco de dados através de MySQL
$sql_cadastro = "INSERT INTO usuarios (nome_usuario, email_usuario, senha_usuario, dt_nascimento_usuario, imagem_usuario) VALUES ('$nome', '$email', '$senha', '$dataNasc', '$imgPerfil')";
