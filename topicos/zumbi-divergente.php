...
$contar_msg = "SELECT * FROM mensagens_topico WHERE topico_msg = 'Zumbi Divergente'";
...
$contar_usuarios = "SELECT autor_msg, COUNT(autor_msg) as total FROM mensagens_topico WHERE topico_msg = 'Zumbi Divergente' GROUP BY autor_msg";
            ...
            <div class="row">
                <div class="col-12 col-lg-9 col-xl-9">
                    <div id="topic" class="d-flex bg-warning mb-0 p-4 rounded-top justify-content-between">
                        <h2 class="h4 mb-0">Zumbi Divergente</h2>
                    ...
                    <table class="table table-striped table-bordered table-responsive">
                        ...
                        <tbody>
                            <?php
                                ...
                                $show_msg = "SELECT * FROM mensagens_topico WHERE topico_msg = 'Zumbi Divergente' LIMIT $inicio, $qnt_pagina";
                    ...
                    <div>
                        ...
                        <?php
                            ...
                            $result_pg = "SELECT COUNT(id_msg) AS num_result FROM mensagens_topico WHERE topico_msg = 'Zumbi Divergente'";
                            ...
                            $maximo_links = 1;
                            // Primeira página
                            echo "<li class='page-item'><a class='page-link' href='./zumbi-divergente.php?pagina=1'>Primeira</a></li>";
                            // Página anterior
                            for($pagina_ant = $pagina - $maximo_links; $pagina_ant <= $pagina - 1; $pagina_ant ++) {
                                if($pagina_ant >= 1) {
                                    echo "<li class='page-item'><a class='page-link' href='./zumbi-divergente.php?pagina=$pagina_ant'>$pagina_ant</a></li>";
                                }
                            }
                            // Página atual
                            ...
                            for($pagina_prox = $pagina + 1; $pagina_prox <= $pagina + $maximo_links; $pagina_prox ++) {
                                if($pagina_prox <= $quantidade_pg) {
                                    echo "<li class='page-item'><a class='page-link' href='./zumbi-divergente.php?pagina=$pagina_prox'>$pagina_prox</a></li>";
                                }
                            }
                            // Última página
                            echo "<li class='page-item'><a class='page-link' href='./zumbi-divergente.php?pagina=$quantidade_pg'>Última</a></li>";
                        ?>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                            ...
                            <select class="form-control" name="topico" id="topico">
                                <option value="Zumbi Divergente">Zumbi Divergente</option>
                            </select>
                        </div>
                        <div class="form-group col-12">
